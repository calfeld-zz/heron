...
(function() {
  var Heron, Receiver, flush_partials, make_thingy, only_keys, send_create, send_update_subkey, split_key, subkey_key, _ref,
    __slice = [].slice;
  ...
  flush_partials = function() {
    ...
    for (id in _ref1) {
      info = _ref1[id];
      this._.make_thingy(info.typename, id, info.attrs, false);
    }
    this._.partials = {};
    return null;
  };
  ...
  Receiver = (function() {
    ...
    Receiver.prototype.create = function(domain, key, value) {
      var attrs, id, info, k, partial_attrs, subkey, v, _base, _base1, _ref1, _ref2, _ref3;
      ...
      if (key === '_synced') {
        ...
        partial_attrs = (_ref3 = (_base1 = this._.partials[id]).attrs) != null ? _ref3 : _base1.attrs = {};
        for (k in attrs) {
          v = attrs[k];
          partial_attrs[k] = v;
        }
