...
(function() {
  var Heron, Receiver, flush_partials, make_thingy, only_keys, send_create, send_create_subkey, send_update_subkey, split_key, subkey_key, _ref,
    __slice = [].slice;
  ...
  Receiver = (function() {
    ...
    Receiver.prototype.create = function(domain, key, value) {
      var attrs, id, info, k, partial_attrs, subkey, v, _base, _base1, _base2, _ref1, _ref2, _ref3, _ref4;
      ...
      if (key === '_synced') {
        ...
        attrs = value;
        if ((_ref2 = (_base = this._.partials)[id]) == null) {
          _base[id] = {};
        }
        ((_ref3 = (_base1 = this._.partials_subkeys)[id]) != null ? _ref3 : _base1[id] = []).push(subkey);
        if (subkey === '_') {
        ...
        partial_attrs = (_ref4 = (_base2 = this._.partials[id]).attrs) != null ? _ref4 : _base2.attrs = {};
        for (k in attrs) {
          v = attrs[k];
          partial_attrs[k] = v;
        }
    ...
    Receiver.prototype.update = function(domain, key, value) {
      var id, k, subkey, thingy_data, type_data, v, _ref1;
      _ref1 = split_key(key), id = _ref1[0], subkey = _ref1[1];
  ...
  Heron.Thingyverse = (function() {
    ...
    function Thingyverse(config) {
      ...
      this._ = {
        ...
        ready: (_ref2 = config.ready) != null ? _ref2 : true,
        synced: false,
        per_thingy: {},
        per_type: {},
        partials: {},
