  ...
  Heron.Dictionary = (function() {
    function Dictionary(config) {
      ...
      this._ = {
        ...
        debug: (_ref = config.debug) != null ? _ref : false,
        path: (_ref1 = config.path) != null ? _ref1 : '/dictionary',
        batch: 0,
        messages: [],
        versions: {},
        receivers: {}
    ...
    Dictionary.prototype.receive = function(json) {
      var active_receivers, ephemeral, message, messages, r, receivers, _base, _base1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _name, _name1;
      ...
      for (_i = 0, _len = messages.length; _i < _len; _i++) {
        ...
        receivers = Heron.Util.values(this._.receivers[message.domain]);
        ...
        switch (message.command) {
          case 'create':
            ...
            if (!ephemeral) {
              if ((_base = this._.versions)[_name = message.domain] == null) {
                _base[_name] = {};
              }
          ...
          case 'update':
            ...
            if (!ephemeral) {
              if ((_base1 = this._.versions)[_name1 = message.domain] == null) {
                _base1[_name1] = {};
              }
              this._.versions[message.domain][message.key] = message.version;
            }
    ...
    Dictionary.prototype.subscribe = function(domain, receiver) {
      ...
      if ((this._.receivers[domain] == null) || Heron.Util.empty(this._.receivers[domain])) {
      ...
      this._.receivers[domain][this._.client_id] = receiver;
      return this;
    };

    Dictionary.prototype.unsubscribe = function(domain) {
      if (this._.client_id == null) {
        throw 'Missing client_id.';
      }
      if ((this._.receivers[domain] == null) || !this._.receivers[domain][this._.client_id]) {
        throw 'Not subscribed.';
      }
      delete this._.receivers[domain][this._.client_id];
      this._.pdebug('UNSUBSCRIBE', domain);
      this._.send_to_server('unsubscribe', {
        domain: domain
      });
      return this;
    };
    ...
    Dictionary.prototype.create = function(domain, key, value) {
      ...
      if (!this._.is_ephemeral(key)) {
        message.version = Heron.Util.generate_id();
        if ((_base = this._.versions)[domain] == null) {
          _base[domain] = {};
        }
        this._.versions[domain][key] = message.version;
      }
